  ...
  return (
    <div className="space-y-10">
      ...
      >
        ...
        <fieldset className="flex items-center border py-2 px-2 rounded-md active:outline w-4/5 md:w-2/3 gap-1 text-primary">
          <UserAddIcon className="h-8 text-place" />
          <select
            name=""
            id=""
            className="bg-transparent outline-none h-10 w-full text-primary"
            value={role}
            onChange={(e) => {
        ...
        <fieldset className="grid items-center">
          <label className="label cursor-pointer space-x-3 flex items-center">
            ...
            <span className="label-text text-primary">
              I agree with FIRS Terms and Privacy Policy
            </span>
          </label>
        </fieldset>
