          ...
          <div className="grid text-primary gap-5 w-full md:grid-cols-2 items-end">
            <label htmlFor="">
              ...
              <select className="select select-primary w-full" name="" id="">
                ...
                {products.map((item) => (
                  <option value="" key={item.productId}>
                    {item.productName}
                  </option>
                ))}
              </select>
            ...
            <label htmlFor="">
              ...
              <input
                class="input input-primary w-full"
                value={shortageClaim(
                  formData.primaryWayBill.quantityLoaded,
                  formData.primaryWayBill.quantityDelivered
                )}
                type="text"
                name=""
                id=""
            ...
            <label htmlFor="">
              ...
              <input
                class="input input-primary w-full"
                value={formData.primaryWayBill.shortageClaim}
                onChange={(e) =>
                  setFormData({
                    ...formData,
                    primaryWayBill: {
                      ...formData.primaryWayBill,
                      shortageClaim: +e.target.value,
                    },
                  })
                }
                placeholder="PMS"
