...
const NotificationsCard = ({
  ...
  return (
    <div className="rounded-lg shadow-md p-5  gap-5 md:col-span-4 md:h-screen md:overflow-y-auto scrollbar-thin scrollbar-track-green-100 scrollbar-thumb-red-700 relative bg-white">
      <div>
